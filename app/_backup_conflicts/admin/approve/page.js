  ...
  if (!auth) {
    return (
      ...
      >
        <form
          onSubmit={login}
          style={{ ...css.card, width: "360px", textAlign: "center" }}
        >
          ...
          <button
            type="submit"
            disabled={loading}
            style={{ ...css.btn, ...css.btnPrimary, width: "100%" }}
          >
            {loading ? "認証中..." : "ログイン"}
          </button>
        </form>
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        height: "60px",
                        borderRadius: "8px",
                        background: getShopPhoto(shop)
                          ? `url(${getShopPhoto(shop)}) center/cover`
                          : "#f1f5f9",
                        display: "flex",
                        alignItems: "center",
                        justifyContent: "center",
                ...
                {selectedShop.status === "pending" && (
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{ ...css.btn, ...css.btnDanger, flex: 1 }}
                    >
                      ❌ 却下
                    </button>
                  </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <div style={{ display: "flex", gap: "4px" }}>
                          <button
                            onClick={() =>
                              updateMenuStatus(selectedShop.id, idx, "approved")
                            }
                            style={{
                              ...css.btn,
                              padding: "4px 8px",
                          ...
                          <button
                            onClick={() =>
                              updateMenuStatus(selectedShop.id, idx, "rejected")
                            }
                            style={{
                              ...css.btn,
                              padding: "4px 8px",
