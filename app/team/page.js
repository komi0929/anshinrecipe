            ...
            <div className="max-w-md mx-auto p-4">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-sm mb-4">
                    ...
                    <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
                        <p>
                            私たちは福岡市内で<a href="https://soystories.jp/" target="_blank" rel="noopener noreferrer" className="text-orange-500 font-bold hover:underline">「SoyStories（ソイストーリーズ）」</a>という小さな小さなスイーツショップを営んでいます。
                        </p>

                        <p>
                            お店では、米粉と豆乳をメインに使ったアレルギーフリーのスイーツをお届けしており、<span className="font-bold text-slate-700">「食に制限のある人に『ユメミタイ』な体験を」</span>をミッションに掲げて活動しています。
                        </p>
