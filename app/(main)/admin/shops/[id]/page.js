          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setShop({ ...shop, website_url: e.target.value })
                }
                className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 outline-none"
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setShop({ ...shop, instagram_url: e.target.value })
                }
                className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 outline-none"
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setShop({ ...shop, image_url: e.target.value })
                }
                className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 outline-none"
              />
            </div>
          ...
          <div className="bg-rose-50 rounded-2xl p-6 shadow-sm border border-rose-100 mb-6">
            ...
            <div className="space-y-3">
              {reports.map((report) => (
                <div
                  key={report.id}
                  className="bg-white p-4 rounded-xl border border-rose-100"
                >
                ...
                <div className="grid grid-cols-2 gap-3 mb-3">
                  <div>
                    ...
                    <input
                      ...
                      value={menu.price || ""}
                      onChange={(e) =>
                        updateMenu(idx, "price", parseInt(e.target.value) || 0)
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateMenu(idx, "image_url", e.target.value)
                      }
                      className="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm"
                      placeholder="https://..."
                    />
                ...
                <div className="mb-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {ALLERGENS.map((allergen) => {
                      const isContained = (
                        menu.allergens_contained || []
                      ).includes(allergen);
                      const isRemovable = (
                        menu.allergens_removable || []
                      ).includes(allergen);
                      return (
                        <div
                          key={allergen}
                        ...
                        >
                          <span className="text-slate-600 w-10">
                            {allergen}
                          </span>
