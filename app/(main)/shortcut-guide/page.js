...
import { ArrowLeft, Home, Smartphone, Copy, Download, Check, CheckCircle, ExternalLink } from "lucide-react";
...
const IOSShortcutPage = () => {
  ...
  const createShortcutUrl = `shortcuts://create-shortcut?name=${encodeURIComponent("あんしんレシピに保存")}&actions=${encodeURIComponent(
    JSON.stringify([
      {
