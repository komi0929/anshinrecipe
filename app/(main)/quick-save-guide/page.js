...
import { Home, Clock, Share, ArrowLeft, Smartphone, Check, Sparkles, Plus, Settings, RefreshCw } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-24">
      ...
      <div className="max-w-md mx-auto p-4">
        ...
        <div
          id="pwa-install"
          className="bg-white rounded-2xl p-5 shadow-sm mb-4 border-2 border-emerald-100 scroll-mt-20"
        >
            ...
            <ul className="text-xs text-slate-600 space-y-2 pl-1">
              ...
              <li className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <br />
                  <span className="font-normal">
                    Instagramの共有メニューに「あんしんレシピ」が表示されます。
                  </span>
                </div>
              </li>
            </ul>
          ...
          <div className="p-4 bg-emerald-50 rounded-xl text-sm text-emerald-700 mb-3">
            <p className="font-bold mb-2 flex items-center gap-2">
              <Smartphone size={16} /> iPhone / Safariの場合:
            </p>
          ...
          <div className="p-4 bg-blue-50 rounded-xl text-sm text-blue-700">
            <p className="font-bold mb-2 flex items-center gap-2">
              <Settings size={16} /> Android / Chromeの場合:
            </p>
            <ol className="list-decimal list-inside space-y-1 text-xs">
              <li>右上のメニュー（⋮）をタップ</li>
        ...
        <div className="bg-amber-50 rounded-2xl p-4 border border-amber-100">
          ...
          <div className="bg-white rounded-lg p-3 text-xs text-slate-600 space-y-2">
            <div className="flex items-start gap-2">
              ...
              <p>
                <b>画面を下に引っ張る</b>と、最新のレシピが読み込まれます
              </p>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-amber-500 font-bold">💡</span>
