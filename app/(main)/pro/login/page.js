        ...
        <div className="pro-easy-content">
          ...
          <div className="pro-easy-description">
            <p className="pro-highlight-block">
              <strong>
                Instagramにすでに投稿されているレシピのURLを再度投稿していただくのみ。
              </strong>
              <br />
              面倒な入力作業は極力AIがしてくれます。
            </p>
            <p>あなたのレシピが、多くのアレルギーっ子家庭に届きます。</p>
          </div>
          <ul className="pro-easy-list">
            <li>
              <CheckCircle size={18} className="text-green-500" />
              <span>
                費用：<strong>完全無料</strong>
              </span>
            </li>
            <li>
              <CheckCircle size={18} className="text-green-500" />
              <span>
                作業：<strong>URLを貼るだけ</strong>
              </span>
            </li>
            <li>
              <CheckCircle size={18} className="text-green-500" />
              <span>
                安心：<strong>プロバッジ付与</strong>
              </span>
            </li>
          </ul>
        </div>
      ...
      <section className="pro-section pro-cta">
        <div className="pro-cta-card">
          ...
          <p className="pro-cta-note">
            ログインをもって{" "}
            <Link href="/terms" className="pro-link">
              利用規約
            </Link>
            ・
            <Link href="/privacy" className="pro-link">
              プライバシーポリシー
            </Link>{" "}
            に同意とみなします
          </p>
