...
import { ArrowLeft, UserPlus, Search, Heart, Bookmark, ShieldCheck, PenTool } from 'lucide-react';
import '../globals.css';
    ...
    return (
        <div className="container" style={{ paddingBottom: '40px' }}>
            ...
            <div className="page-header" style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                <Link href="/profile" style={{ display: 'flex', alignItems: 'center', color: 'var(--color-text-sub)' }}>
                    <ArrowLeft size={24} />
                </Link>
                <h1 className="page-title" style={{ marginBottom: 0 }}>アプリの使い方</h1>
            </div>

            <div style={{ maxWidth: '600px', margin: '0 auto' }}>
                <div className="card fade-in">
                    <h2 style={{ fontSize: '1.25rem', marginBottom: '16px', color: 'var(--color-primary)', textAlign: 'center' }}>
                        あんしんレシピへようこそ！
                    </h2>
                    <p style={{ lineHeight: '1.8', color: 'var(--color-text-main)', marginBottom: '24px' }}>
                        このアプリは、食物アレルギーを持つお子様のために、
                        <strong>「家族みんなで安心して食べられる」</strong>レシピを見つけるための場所です。
                    </p>
                </div>
                ...
                <div className="card fade-in" style={{ animationDelay: '0.1s' }}>
                    <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                        ...
                        <div>
                            ...
                            <p style={{ color: 'var(--color-text-sub)', fontSize: '0.9rem', lineHeight: '1.6' }}>
                ...
                <div className="card fade-in" style={{ animationDelay: '0.4s' }}>
                    <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                        ...
                        <div>
                            ...
                            <p style={{ color: 'var(--color-text-sub)', fontSize: '0.9rem', lineHeight: '1.6', marginBottom: '12px' }}>
