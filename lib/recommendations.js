...
export async function getRecommendedRecipes(currentRecipe, limit = 6) {
    ...
    try {
        ...
        const scored = candidates.map(recipe => {
            ...
            const currentAllergens = currentRecipe.free_from_allergens || [];
            const recipeAllergens = recipe.free_from_allergens || [];
            ...
            const currentIngredients = currentRecipe.positive_ingredients || [];
            const recipeIngredients = recipe.positive_ingredients || [];
