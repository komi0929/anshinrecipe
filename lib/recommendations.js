 ...
 * @param {Object} currentRecipe - The current recipe being viewed
 * @param {number} limit - Maximum number of recommendations
 * @param {string} excludeUserId - User ID to exclude (to hide user's own recipes)
 */
export async function getRecommendedRecipes(currentRecipe, limit = 6, excludeUserId = null) {
    ...
    try {
        ...
        // Also exclude current user's recipes if excludeUserId is provided
        if (excludeUserId) {
