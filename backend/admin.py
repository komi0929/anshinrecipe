    ...
    <body class="bg-gray-100">
            ...
            <div class="flex-1 overflow-auto">
                <div class="p-8">
                    ...
                    <div id="domains-section" class="content-section hidden">
                        ...
                        <!-- Loading Indicator for Domains -->
                        <div id="domains-loading-indicator" class="text-center py-8">
                            <div class="text-gray-600">ドメインデータを読み込み中...</div>
                        </div>
                        ...
                        <div id="domains-content" style="display: none;">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                                <div class="bg-white p-6 rounded-lg shadow text-center">
                                    <div class="text-sm font-medium text-gray-600">総ドメイン数</div>
                                    <div id="total-domains" class="text-3xl font-bold text-blue-600 mt-2">-</div>
                                </div>
                                <div class="bg-white p-6 rounded-lg shadow text-center">
                                    <div class="text-sm font-medium text-gray-600">違反ドメイン</div>
                                    <div id="domains-violations" class="text-3xl font-bold text-red-600 mt-2">-</div>
                                </div>
                                <div class="bg-white p-6 rounded-lg shadow text-center">
                                    <div class="text-sm font-medium text-gray-600">平均CTR</div>
                                    <div id="avg-domain-ctr" class="text-3xl font-bold text-green-600 mt-2">-%</div>
                                </div>
                                <div class="bg-white p-6 rounded-lg shadow text-center">
                                    <div class="text-sm font-medium text-gray-600">平均あんしんスコア</div>
                                    <div id="avg-domain-score" class="text-3xl font-bold text-purple-600 mt-2">-</div>
                                </div>
                            </div>

                            <!-- Violations Alert -->
                            <div id="violations-alert" class="mb-6" style="display: none;">
                                <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3">
                                            <h3 class="text-sm font-medium text-red-800">ドメイン制約違反検出</h3>
                                            <div class="mt-2 text-sm text-red-700" id="violations-list"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-white rounded-lg shadow overflow-hidden">
                                <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                                    <h3 class="text-lg font-semibold text-gray-900">Top 10 レシピソースドメイン</h3>
                                    <div class="text-sm text-gray-500">CTRでソート可能</div>
                                </div>
                                <div class="overflow-x-auto">
                                    <table class="min-w-full table-auto">
                                        <thead class="bg-gray-50">
                                            <tr>
                                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" onclick="sortDomainsTable('domain')">
                                                    ドメイン
                                                    <span class="sort-indicator" id="sort-domain">↕</span>
                                                </th>
                                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" onclick="sortDomainsTable('impressions')">
                                                    インプレッション
                                                    <span class="sort-indicator" id="sort-impressions">↕</span>
                                                </th>
                                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" onclick="sortDomainsTable('clicks')">
                                                    クリック
                                                    <span class="sort-indicator" id="sort-clicks">↕</span>
                                                </th>
                                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" onclick="sortDomainsTable('ctr')">
                                                    CTR
                                                    <span class="sort-indicator" id="sort-ctr">↓</span>
                                                </th>
                                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" onclick="sortDomainsTable('score')">
                                                    あんしんスコア
        ...
        <script>
            ...
            function setDateRange(days) {
                ...
                // Reload data if we're on overview, context, quality, or funnel
